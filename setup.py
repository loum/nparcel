...
setup(name='python-nparcel',
      ...
      scripts=['nparcel/bin/toploaderd',
               'nparcel/bin/topexporterd',
               'nparcel/bin/topreminderd',
               'nparcel/bin/topftp',
               'nparcel/bin/topinit',
               'nparcel/bin/toppostcode',
               'nparcel/bin/topondeliveryd',
               'nparcel/bin/topcommsd',
               'nparcel/bin/topmapperd',
               'nparcel/bin/topfilterd',
               'nparcel/bin/topreporter',
               'nparcel/bin/tophealth',
               'nparcel/bin/toppod',
               'nparcel/bin/topadpd',
               'nparcel/bin/toppodmigrate',
               'nparcel/bin/toppoderd',
               'nparcel/bin/topctrl'],
      packages=['nparcel',
                'nparcel.table',
                'nparcel.report',
